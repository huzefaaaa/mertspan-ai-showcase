...
const Footer = () => {
  return (
    <footer className="bg-card text-foreground py-16 sm:py-20 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          {/* Company Info */}
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-primary">Mertspan</h3>
          ...
          {/* Contact Info */}
          <div className="space-y-6">
            <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-6">Contact</h4>
            
            <div className="space-y-4">
              <a
                href="tel:+447393993313"
                className="flex items-center gap-3 text-foreground/80 hover:text-primary transition-colors text-sm"
              >
